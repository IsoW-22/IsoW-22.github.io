"use strict"
class Calculator {
    constructor(displayValue, firstNumber, waitingForSecondNumber, operator, expression, prevOp, prevNumber){
    ...
    inputOperators = (comingOperator) => {
        ...
        } else if(comingOperator == '=' && this.operator == '=' && this.prevNumber){
      ...
      console.log(this);
        switch(operator){
            ...
            case '*': this.prevOp = "*";
              ...
              return firstNumber * secondNumber;
            case '/': if (!(isFinite(firstNumber / secondNumber))){
